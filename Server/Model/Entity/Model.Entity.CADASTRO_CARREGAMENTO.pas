...
type
  ...
  private
    ...
    FPESO_LIQ_CARGA: real;
    FFRETE_TONELADA: real;
    FTOTAL_FRETE: real;
    FKM_INICIO: real;
    FKM_CHEGADA: real;
    FTOTAL_KM_RODADOS: real;
...
{Exemplo: [Campo('NOME_CAMPO'), PK, AutoInc] }
    ...
    property PESO_LIQ_CARGA: real read FPESO_LIQ_CARGA write FPESO_LIQ_CARGA;
    [Campo('FRETE_TONELADA')]
    property FRETE_TONELADA: real read FFRETE_TONELADA write FFRETE_TONELADA;
    [Campo('TOTAL_FRETE')]
    property TOTAL_FRETE: real read FTOTAL_FRETE write FTOTAL_FRETE;
    [Campo('KM_INICIO')]
    property KM_INICIO: real read FKM_INICIO write FKM_INICIO;
    [Campo('KM_CHEGADA')]
    property KM_CHEGADA: real read FKM_CHEGADA write FKM_CHEGADA;
    [Campo('TOTAL_KM_RODADOS')]
    property TOTAL_KM_RODADOS: real read FTOTAL_KM_RODADOS write FTOTAL_KM_RODADOS;
